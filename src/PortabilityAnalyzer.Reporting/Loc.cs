...
public static class Loc
{
    ...
    public static string FixEn(string categoria) => categoria switch
    {
        ...
        "Threading" => "The BCL threading model (Thread, Task, Parallel, async/await, ThreadPool, SemaphoreSlim, System.Threading.Timer) is already cross-platform. Only the WPF bits change: DispatcherTimer -> portable PortableTimer shim (System.Timers.Timer); Dispatcher.Invoke/BeginInvoke -> async/await + IProgress<T>. STAThread is a no-op off Windows.",
