...
public static class LibraryReplacements
{
    ...
    private static readonly Entry[] Table =
    {
        ...
        new("System.Security.Cryptography.ProtectedData", false, LibraryStatus.Reemplazar, "Microsoft.AspNetCore.DataProtection.Extensions", "8.0.10", null, null,
            "DPAPI (solo Windows) -> ASP.NET Core Data Protection (Microsoft.AspNetCore.DataProtection), multiplataforma y transparente al SO. Encapsular Protect/Unprotect en un helper portable con IDataProtectionProvider (DataProtectionProvider.Create) manteniendo la misma API.",
            "DPAPI (Windows only) -> ASP.NET Core Data Protection (Microsoft.AspNetCore.DataProtection), cross-platform and OS-transparent. Wrap Protect/Unprotect in a portable helper using IDataProtectionProvider (DataProtectionProvider.Create) keeping the same API."),
